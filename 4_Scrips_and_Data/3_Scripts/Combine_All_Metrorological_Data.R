...
#solar
solar_txt_Historical_Hour <- import("4_Data/3_DWD_Meteorological_Data/DWD_Wetherdata/Hourly/Historical/solar_stundenwerte_ST_01975_row/produkt_st_stunde_20050101_20220228_01975.txt")
...
solar_1h <- solar_txt_Historical_Hour[(solar_txt_Historical_Hour$MESS_DATUM > StartDate),]
