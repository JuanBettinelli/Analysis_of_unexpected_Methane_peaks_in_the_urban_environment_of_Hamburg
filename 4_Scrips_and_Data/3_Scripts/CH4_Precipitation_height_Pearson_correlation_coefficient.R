...
for (Wind_Provider in 1:4){
  ...
  Correlation_Plot <- ggplot()+
    ...
    labs(x = "Wind direction. °", y = "Wind speed, m/s", title = "Pearson's correlation coefficient between methane and precipitation, binned by wind direction and wind speed")
  ...
  P_value_Plot <- ggplot()+
    ...
    labs(x = "Wind direction. °", y = "Wind speed, m/s", title = "5% P-value test for methane and precipitation, binned by wind direction and wind speed")+
