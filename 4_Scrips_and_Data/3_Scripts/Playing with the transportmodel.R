...
# Particles_Tracks_Changing_Wind <- function(TotalData, No_of_Releast_Particals = 10, sd_Speed = 0.5, sd_Direction = 30, Wind_Provider = 1){
  ...
  mv_Raster <- mapview(density_raster, 
                       ...
                       legend = TRUE) 
  # Save the Map
  mapshot(mv_Raster, file = "4_Data/OutputData/Plots/10_Maps/10_Emission_Distribution_with_Changing_Measured_Wind_test.png", remove_controls = c("zoomControl", "layersControl", "homeButton", "drawToolbar", "easyButton"))
# }
