# Script to plot the Methane Timeline with the Bondary layer
...
TotalData_CH4_BLH <- TotalData[complete.cases(TotalData[ , c("UTC", "ERA5_BLH")]),]
 ...
 png(file="4_Data/OutputData/Plots/19_BondaryLayer/19_Basic_Plot_CH4_ERA5.png",
...
mtext("CH4 Concentration",
 ...
 png(file="4_Data/OutputData/Plots/19_BondaryLayer/19_Basic_Plot_CH4_LIDAR.png",
     width=1200, height=600)
 par(mar = c(5, 4, 4, 4) + 0.3, mfrow=c(1,1))  # Leave space for z axis
