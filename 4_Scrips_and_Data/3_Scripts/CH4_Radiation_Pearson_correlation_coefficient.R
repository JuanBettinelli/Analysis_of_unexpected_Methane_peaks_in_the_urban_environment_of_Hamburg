...
for (Wind_Provider in 1:4){
  ...
  Correlation_Plot <- ggplot()+
    ...
    labs(x = "Wind direction. °", y = "Wind speed, m/s", title = "Pearson's correlation coefficient for Methan and radiation, depending on Wind Direction and Speed")
  ...
  P_value_Plot <- ggplot()+
    ...
    labs(x = "Wind direction. °", y = "Wind speed, m/s", title = "P-value Test for Methan and radiation, depending on Wind Direction and Speed")+
